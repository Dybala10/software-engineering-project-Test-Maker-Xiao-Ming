...
Page({
  ...
  clickMe: function (e) {
    ...
    while (i == true) {
      ...
      fn1 = Math.floor(Math.random() * 100 + 1)*100;
      fn2 = Math.floor(Math.random() * 100 + 1)*100;
