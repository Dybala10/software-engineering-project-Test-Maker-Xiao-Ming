...
Page({
  ...
  clickMe: function (e) {
    ...
    while (i == true) {
      ...
      fn2 = Math.floor(Math.random() * 100 + 1);
      fn3 = Math.floor(Math.random() * 100 + 1);
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result1 = fn1 + fn2;
        result1 = fn1 + fn2 + fn3;
        if (result1 >= 0 && result1 < 100 && ((m_result1 < 10 && m_result1 >= 0) || (m_result1 % 10 == 0 && m_result1 < 100 && m_result1 >= 0))) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result2 = fn2 + fn3;
        result2 = fn1 + fn2 + fn3;
        if (result2 >= 0 && result2 < 100 && ((m_result2 < 10 && m_result2 >= 0) || (m_result2 % 10 == 0 && m_result2 < 100 && m_result2 >= 0))) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result3 = fn1 + fn2;
        result3 = fn1 + fn2 + fn3;
        if (result3 >= 0 && result3 < 100 && ((m_result3 < 10 && m_result3 >= 0) || (m_result3 % 10 == 0 && m_result3 < 100 && m_result3 >= 0))) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result4 = fn2 + fn3;
        result4 = fn1 + fn2 + fn3;
        if (result4 >= 0 && result4 < 100 && ((m_result4 < 10 && m_result4 >= 0) || (m_result4 % 10 == 0 && m_result4 < 100 && m_result4 >= 0))) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result5 = fn1 + fn2;
        result5 = fn1 + fn2 + fn3;
        if (result5 >= 0 && result5 < 100 && ((m_result5 < 10 && m_result5 >= 0) || (m_result5 % 10 == 0 && m_result5 < 100 && m_result5 >= 0))) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
  ...
  checkit: function (e) {
    ...
    if (this.data.inputnum == this.data.result) {
      ...
      if (this.data.again == 1) {
        ...
        if (this.data.cc == 1 || this.data.cc == 3 || this.data.cc == 5) {
          app.globalData.cuoti.push(this.data.item.kuo1 + this.data.item.num1 + this.data.item.sym1 + this.data.item.num2 + this.data.item.kuo2 + this.data.item.sym2 + this.data.item.num3);
          wx.setStorage({
            key: 'cuoti',
          ...
          app.globalData.cuoti.push(this.data.item.num1 + this.data.item.sym1 + this.data.item.kuo3 + this.data.item.num2 + this.data.item.sym2 + this.data.item.num3 + this.data.item.kuo4);
          wx.setStorage({
            key: 'cuoti',
            data: app.globalData.cuoti,
          });
