  ...
  clickMe: function (e) {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        ...
        result1 = fn1 - fn2 + fn3;
        m_result1 = fn1 - fn2;
        if (result1 < 100 && result1 >= 0 && m_result1 >= 0) {
          i = false;
        }
      }
      else if (fs1 == '-' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        ...
        result2 = fn1 - fn2 + fn3;
        m_result2 = fn1 - fn2;
        if (result2 < 100 && result2 >= 0 && m_result2 >= 0) {
          i = false;
        }
      }
      else if (fs1 == '-' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        ...
        result3 = fn1 - fn2 + fn3;
        m_result3 = fn1 - fn2;
        if (result3 < 100 && result3 >= 0 && m_result3 >= 0) {
          i = false;
        }
      }
      else if (fs1 == '-' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result4 = fn2 + fn3;
        result4 = fn1 + fn2 + fn3;
        if (result4 >= 0 && result4 < 100 && m_result4 >= 0 && m_result4 < 100) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
    ...
    while (i == true) {
      ...
      if (fs1 == '+' && fs2 == '+') {
        m_result5 = fn1 + fn2;
        result5 = fn1 + fn2 + fn3;
        if (result5 >= 0 && result5 < 100 && m_result5 >= 0 && m_result5 < 100) {
          i = false;
        }
      }
      else if (fs1 == '+' && fs2 == '-') {
