...
Page({
  ...
  clickMe: function (e) {
    ...
    if (choose == 1) {
      that.setData({
        result: result1 + '/' + this.data.item1.num4,
        item: {
      ...
      that.setData({
        result: result2 + '/' + this.data.item2.num4,
        item: {
      ...
      that.setData({
        result: result3 + '/' + this.data.item3.num4,
        item: {
